...
const myFirstProject = ({ registerText, unregisterText }) => {
  ...
  <>
      {isMobile ? (
        <div className="flex w-full h-[70vh] flex-col justify-center items-center mt-[-20vh] gap-3 bg-transparent text-white">
          <p className="flex justify-end w-full text-sm -mr-6">Date: 12-10-2023</p>
      ...
      <p className="text-[#F6F0F0] select-none capitalize text-center w-[75vw] leading-loose">This is my first frontend website, it is build in html and css and little bit of javascript. This is my first ever project to learn things, from here my journey started.</p>
      </div>
      ):(
          <div  className="flex myWork w-full third h-[100vh] flex-col justify-center items-center py-6 gap-10 bg-transparent">
        ...
        onMouseMove={(e) => {
          ...
          className="text-2xl myWork11 font-bold ml-[35.4vw] transform-gpu transition-transform duration-300 ease-out preserve-3d hover:shadow-xl ">My First Frontend Website</h2>
        <p ref={(el) => (textRefs.current[1] = el)}
          ...
          className="mr-14 myWork22">Date: 12-10-2023</p>
          </div>
            <div className="flex myWork33 hover:z-10 justify-center items-center w-[35vw] h-[35vh] object-cover rounded-lg overflow-hidden">
                <ReactPlayer
                url={FirstProject}
                controls
                width="100%"
      ...
      <p ref={(el) => (textRefs.current[2] = el)}
        onMouseMove={(e) => {
          ...
          onMouseLeave={(e) => handleTextHover(false, e.currentTarget)}
        className="text-[#F6F0F0] capitalize myWork44 select-none text-center mt-5 w-[35vw] leading-loose">This is my first frontend website, it is build in html and css and little bit of javascript. This is my first ever project to learn things, from here my journey started.</p>
      </div>
      )}
      </>
  )
